...
<head>
    ...
    <link id="favicon" rel="shortcut icon" type="image/x-icon" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/base/images/favicon-notebook.ico?v=eb02bb6f6435d048eba1bf1bd3b3621f8c14f26518dbadd8efd4ee6ee2721caf2367bc0cbc27d2ee2c35bc3b035aad07c6d625422b9445bf301897f493d0edc5">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/jquery-ui/dist/themes/smoothness/jquery-ui.min.css?v=32f9dcde0cd9843f2b66d34c1c9928b59a5d7ef007ba7a6a6a790b3e78f7857a698444d7a716dfaf8fa834c3b3175efd258bbc07cfc4aabb86769b07e5f358c3" type="text/css" />
    <link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/jquery-typeahead/dist/jquery.typeahead.min.css?v=5edf53bf6bb9c3b1ddafd8594825a7e2ed621f19423e569c985162742f63911c09eba2c529f8fb47aebf27fafdfe287d563347f58c1126b278189a18871b6a9a" type="text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    


<script type="text/javascript" src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML-full,Safe&delayStartupUntil=configured" charset="utf-8"></script>

<script type="text/javascript">
// MathJax disabled, set as null to distinguish from *missing* MathJax,
// where it will be undefined, and should prompt a dialog later.
window.mathjax_url = "/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/MathJax/MathJax.js";
</script>

<link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/bootstrap-tour/build/css/bootstrap-tour.min.css?v=95c93e52db61ab29625defe55361384ce6776a7d303b97da5a73fef5ddf8e391a6223599a0b58669476bd71645a4f0022df0517c88b0c05df80ba465e36f5417" type="text/css" />
<link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/codemirror/lib/codemirror.css?v=a545ad5e21a51420a7cb40234688eef087a5cf3798f64d7750291a8be0e9c760b8a1c9cbbbdcaa6470f2f385caa59e816f2640f609d29147f4762e27f69709e6">


    <link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/style/style.min.css?v=e1ab1c38b672063a6541baf468c83345cd0f509729783ec9b7ccb64073004f5f056110c82c28aefbf3dbf32e0e040f05b8f0420bc411b669ed3d4f07511812ca" type="text/css"/>
    

<link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/notebook/css/override.css?v=16733f6ba5f2224692fe4e654f3cbb2e3cae82f1df06ca53aa1cb88b147465f16c968c0898e2b0203a7ad3a469f82b959e26bb4b27b790f7f364c4336449b0aa" type="text/css" />
<link rel="stylesheet" href=""  id='kernel-css'                             type="text/css" />


    <link rel="stylesheet" href="/user/hanyang.guo@mail.utoronto.ca/custom/custom.css" type="text/css" />
    <script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/es6-promise/promise.min.js?v=bea335d74136a63ae1b5130f5ac9a50c6256a5f435e6e09fef599491a84d834a8b0f011ca3eaaca3b4ab6a2da2d3e1191567a2f171e60da1d10e5b9d52f84184" type="text/javascript" charset="utf-8"></script>
    <script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/react/react.production.min.js?v=9a0aaf84a316c8bedd6c2ff7d5b5e0a13f8f84ec02442346cba0b842c6c81a6bf6176e64f3675c2ebf357cb5bb048e0b527bd39377c95681d22468da3d5de735" type="text/javascript"></script>
    <script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/react/react-dom.production.min.js?v=6fc58c1c4736868ff84f57bd8b85f2bdb985993a9392718f3b4af4bfa10fb4efba2b4ddd68644bd2a8daf0619a3844944c9c43f8528364a1aa6fc01ec1b8ae84" type="text/javascript"></script>
    <script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/create-react-class/index.js?v=894ad57246e682b4cfbe7cd5e408dcd6b38d06af4de4f3425991e2676fdc2ef1732cbd19903104198878ae77de12a1996de3e7da3a467fb226bdda8f4618faec" type="text/javascript"></script>
    <script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/requirejs/require.js?v=d37b48bb2137faa0ab98157e240c084dd5b1b5e74911723aa1d1f04c928c2a03dedf922d049e4815f7e5a369faa2e6b6a1000aae958b7953b5cc60411154f593" type="text/javascript" charset="utf-8"></script>
    <script>
      document.nbclassicPath = '';
      require.config({
          
          urlArgs: "v=20240920001040",
          
          baseUrl: '/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/',
          paths: {
            'auth/js/main': 'auth/js/main.min',
            custom : '/user/hanyang.guo@mail.utoronto.ca/custom',
            'custom-preload' : '/user/hanyang.guo@mail.utoronto.ca/custom-preload',
            nbextensions : '/user/hanyang.guo@mail.utoronto.ca/nbextensions',
            kernelspecs : '/user/hanyang.guo@mail.utoronto.ca/kernelspecs',
...
<body class="notebook_app "
    ...
    data-jupyter-api-token="5df1ada690f74c97b21121d8ccfc012a"
  
 
data-base-url="/user/hanyang.guo%40mail.utoronto.ca/"
data-ws-url=""
data-notebook-name="STA130F24_HW02_DueSep19-Copy1.ipynb"
data-notebook-path="STA130F24_HW02_DueSep19-Copy1.ipynb"
...
<div id="header" role="navigation" aria-label="Top Menu">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="
    <div id="ipython_notebook" class="nav navbar-brand"><a href="/user/hanyang.guo@mail.utoronto.ca/tree?token=5df1ada690f74c97b21121d8ccfc012a" title='dashboard'>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Help</a>
                    <ul  id="help_menu" class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li title="About Jupyter NbClassic"><a id="notebook_about" href="#">About</a></li>
...
<script type="text/javascript">
    sys_info = {"jupyter_server_version": "2.12.1", "jupyter_server_path": "/opt/conda/lib/python3.11/site-packages/jupyter_server", "commit_source": "", "commit_hash": "", "sys_version": "3.11.6 | packaged by conda-forge | (main, Oct  3 2023, 10:40:35) [GCC 12.3.0]", "sys_executable": "/opt/conda/bin/python3.11", "sys_platform": "linux", "platform": "Linux-5.15.0-1052-azure-x86_64-with-glibc2.35", "os_name": "posix"};
</script>

<script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/components/text-encoding/lib/encoding.js?v=737ac6f9f978afb6348b5914877e7d7136de7465cd4cdf389bad9a6b3ad5ceffbfb23febc75c23378967d7d36f98f5388208e8eb78c80f2bf47e8f8c000481ad" charset="utf-8"></script>

<script src="/user/hanyang.guo@mail.utoronto.ca/static/nbclassic/notebook/js/main.min.js?v=8466c8620663540fdc27aa2909a08588e99362a9bd2a0ebb7fd2e651f6b56c4f48c687d0ef4b0a1240fecbd4fa916be2572e7b3f78bf802410e93cca283276db" type="text/javascript" charset="utf-8"></script>
